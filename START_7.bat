@echo off
title FB Group Joiner - Profile 7
cd /d "%~dp0"
...
rem Purana tkinter UI backup: is folder mein  py fb_joiner.py 7
where pyw >nul 2>&1 && ( start "" pyw fb_joiner_ui.py 7 & exit /b 0 )
start "" py fb_joiner_ui.py 7
exit /b 0
