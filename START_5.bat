@echo off
title FB Group Joiner - Profile 5
cd /d "%~dp0"
...
rem Purana tkinter UI backup: is folder mein  py fb_joiner.py 5
where pyw >nul 2>&1 && ( start "" pyw fb_joiner_ui.py 5 & exit /b 0 )
start "" py fb_joiner_ui.py 5
exit /b 0
