...
rem Purana tkinter UI backup: is folder mein  py fb_joiner.py 
where pyw >nul 2>&1 && ( start "" pyw fb_joiner_ui.py  & exit /b 0 )
start "" py fb_joiner_ui.py 
exit /b 0
